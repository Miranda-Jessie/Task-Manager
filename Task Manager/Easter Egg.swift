...
func easterEgg() {
    ...
    if userInputForEasterEgg == "" {
        print("\nHey! What are you doing here? Since you wanted to go snooping I guess I only have one option left to do... BOOM! You are dead. I hope you are happy. Maybe next time you wont try and find something to get into. Have a good rest of your day ;) ")
    }
